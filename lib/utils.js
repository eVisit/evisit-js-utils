...
function instanceOf(obj) {
  ...
  if (arguments.length === 2 && arguments[1] === 'object')
    return (arguments[0] && !instanceOf(arguments[0], 'string', 'number', 'boolean', 'array', 'function'));
...
/**
* @function {first} returns the first element of provided Array.
*	If the provided param is not an instance of Array, *undefined* is returned.
* @param {Array} {a} Array to get element from
* @return {*} first element of array, **undefined** if does not exist.
*/
function first(a) {
...
/**
* @function {last} returns the last element of provided Array.
*	If the provided param is not an instance of Array, *undefined* is returned.
* @param {Array} {a} Array to get element from
* @return {*} last element of array, **undefined** if does not exist.
*/
function last(a) {
  if (a instanceof Array && a.length > 0)
    return a[a.length - 1];
...
function safeJSONStringify(obj, formatter, space) {
  function safeCloneObj(key, value, _alreadyVisited) {
    ...
    var alreadyVisited = _alreadyVisited || [],
        index = alreadyVisited.findIndex((obj) => (obj.oldValue === value));
